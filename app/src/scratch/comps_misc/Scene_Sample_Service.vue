...
<script>
  ...
  import featurelayer_configs from "../modules/featureLayer_configs_Sample_Service";
  ...
  const { symbols, popupTemplate, renderers } = featurelayer_configs
    ...
    mounted(){
      ...
      loadModules(['esri/Map', 'esri/views/MapView', 'esri/views/SceneView', 'esri/Graphic', 'esri/geometry/support/webMercatorUtils', 'esri/layers/FeatureLayer', 'esri/widgets/Legend'],{dojoConfig}).then(([Map, MapView, Scene, Graphic, WMU, FeatureLayer, Legend])=>{
        ...
        // :: ------------------------------------------ :: \\
          ...
          //   symbol.symbolLayers[0].size = v.attributes.Height * 0.3048;
          //   // symbol.symbolLayers[0].size = v.attributes.Height * .05;
          //   lidar_graphic.attributes = v.attributes;
          //   lidar_graphic.symbol = symbol;
